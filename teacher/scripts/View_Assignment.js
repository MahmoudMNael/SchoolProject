...
let Comment_Sections = [
	new Comment_Section(0, 'Mazen:', 'Just Adding Comment Here.'),

	new Comment_Section(1, 'Ebrahim:', 'Adding Comment Number 2 Here'),

	new Comment_Section(2, 'Nael:', 'Guess What it is the third Comment.'),

	new Comment_Section(3, 'Mohamed:', 'It is The Fourth I Guess.'),

	new Comment_Section(4, 'Omar:', 'Finally Last Comment.'),
];
...
if (!localStorage.getItem('details')) {
	let Assignments = [
		new Assignment(0, 'Math:', 'Here is the details of assignment Math.'),

		new Assignment(1, 'Science:', 'Here is the details of assignment Math.'),

		new Assignment(2, 'Arabic:', 'Here is the details of assignment Arabic.'),
